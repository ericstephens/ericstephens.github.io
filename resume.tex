...
Orchestrator of complex, cross-functional initiatives that deliver measurable business outcomes through strategic planning and stakeholder alignment. Proven track record managing enterprise-scale programs across strategy consulting, sales engineering, enterprise architecture, and software engineering. Successfully delivery across retail, life sciences, mobile telecom, media \& entertainment, financial services, healthcare, and public sector organizations.
...
Engaged in multi-faceted role supporting orchestrating strategy \& planning (S\&P) duties for the Chief Architect, evolving Enterprise Document Management (EDM) capabilities, pioneering portfolio-wide business architecture and portfolio management practices, and improving enterprise architecture (EA) practices through an EA Guild.
...
Simultaneously, represented the team with the firm-wide EA governance body (TAG-BP), co-lead the firm-wide AI Ethics workgroup with publication of a quarterly newsletter, provided consultative services for the Log4Shell vulnerability (ca. 2021) response, and workflow automation architecture refactoring (Autumn 2022), and led / contributed to several volunteer Common Impact projects providing advisory services to non-profits.
