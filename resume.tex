...
\item \textbf{EDM}. Provided leadership of team evolving this capability including creation of common APIs, contingent architectures, and Accessibility solutions to support critical enterprise capability. Developed business case with thorough economic view to inform key stakeholders in decision-making.
\end{itemize}

Simultaneously, represented the team with the firm-wide EA governance body (TAG-BP), co-lead the firm-wide AI Ethics workgroup with publication of a quarterly newsletter, provided consultative services workflow automation architecture (Digital Automation Platform) refactoring (Autumn 2022), for the Log4Shell vulnerability (ca. 2021) response, and  and led / contributed to several volunteer Common Impact projects providing advisory services to non-profits.

\textbf{Principal, Business Value Consulting - Americas} \hfill Oct 2016 - Sep 2021\\
Commvault \hfill \textit{Tinton Falls, NJ}\\
Achieved or exceeded revenue targets in dual role elevating our collaboration in accounts resulting in expanded deal size with heavy emphasis on business case development for prospects and clients. Engaged into channel ecosystem to establish new partners. Develop and deliver enablement material to assist in pre-sales requirements engineering / discovery practices.

Led role in developing next iteration of go-to-market (GTM) process for EA-centric, capability-driven advisory engagements. Leveraged strategic consulting and EA practices in a highly tailored fashion. Formulated market sizing analysis for strategic partners to drive sales pipeline.
